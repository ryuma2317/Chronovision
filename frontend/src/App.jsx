...
import CoursePrediction from './pages/student/CoursePrediction';
    ...
    <ToastProvider>
      <ErrorBoundary>
          ...
          <Route path="/student" element={<RoleRoute role="student" />}>
            ...
            <Route path="predict" element={<CoursePrediction />} />
            <Route path="predict-courses" element={<CoursePrediction />} />
          ...
          <Route path="/admin" element={<RoleRoute role="admin" />}>
            ...
            <Route path="classes/:id/courses" element={<ClassCourses />} />
            <Route path="profile" element={<Profile />} />
